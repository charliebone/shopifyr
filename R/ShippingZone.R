...
#' @templateVar name ShippingZone
#' @templateVar urlSlug store-properties/shippingzone
#' @templateVar default.params FALSE
#' @templateVar default.return FALSE
#' @return a list of ShippingZones
#' @template api
NULL

## GET /admin/api/#{api_version}/shipping_zones.json
